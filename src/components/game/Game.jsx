...
function Game() {
  ...
  /*As variaveis clickCel resepresentam se uma das células do tabuleiro já foi escolhido.
    Começam inicialmente com falso e quando uma jogada aconte sua respectiva variavel se torna verdadeiro
    representado que ja foi clicado.
  */
  ...
  /*As variaveis de valor são conteudo de cada célula, inicialmente vazias " " e podem assumir "x" ou "o" */
  ...
  useEffect(()=>{
    /*Condições de vitória, uma linha, coluna ou diagonal peenchidas com o mesmo valor*/
    ...
    /*condição de empate, todas as casas preenchidas sem alcançar uma condição de vitória*/
  ...
  return (
    ...
    <body id='bodyApp'>
      ...
      <h1>vez de: {player}</h1>}
      <div className='game'>
{/*OnClick de todos os botões rescebem uma codicional para que o valor de cada célula so seja alterado uma vez*/}
